function (user, context, callback) {
   ...
   * Unknown at 2022-02-16T03:46:42.763Z
   */
  ...
  var config = {
    endpoints: {
      linking: 'https://kikeyama-sandbox-1.us.webtask.run/4cb95bf92ced903b9b84ebedbf5ebffd',
      userApi: auth0.baseUrl + '/users',
      usersByEmailApi: auth0.baseUrl + '/users-by-email'
    },
    token: {
      clientId: 'uFBI2B8NhlSfm2qyjNBIHXkQUPnuDYYT',
      clientSecret: 'rm7CxeMe9W6ewRQau15ahIRuXH6PYy5tygsjdc4fXHHE8enyR94dBE0uoLcMXpIU',
      issuer: auth0.domain
    }
  };
